            ...
            a.e_map_body.kvs.forEach((kv) => {
                if (kv.key && kv.key.exprs && kv.key.exprs[0]) {
                    if (kv.value && kv.value.exprs && kv.value.exprs[0]) {
                        obj[(0, exports.rhoExprToVar)(kv.key.exprs[0])] = (0, exports.rhoExprToVar)(kv.value.exprs[0]);
                    }
                    else {
                        obj[(0, exports.rhoExprToVar)(kv.key.exprs[0])] = null;
                    }
                }
            });
            return obj;
...
//# sourceMappingURL=rhoExprToVar.js.map