...
export declare const easyDeploy: (urlOrOptions: string | ValidateUrlOptions, payload: {
    term: string;
...
export declare const dataAtNameByBlockHash: (urlOrOptions: string | ValidateUrlOptions, options: DataAtNameByBlockHashOptions) => Promise<string>;
